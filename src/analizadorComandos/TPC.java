...
public class TPC {
    ...
    private static final LinkedList<String> lexemas = new LinkedList<>(Arrays.asList(
            ...
            ,"MODIFICARNIVELINDICADOR"
            //TIPOENCUESTA
            ,"OBTENERTIPOENCUESTA"
            ,"REGISTRARTIPOENCUESTA"
            ,"ELIMINARTIPOENCUESTA"
            ,"MODIFICARTIPOENCUESTA"
            //NIVELMODELO
            ,"OBTENERNIVELMODELO"
            ,"REGISTRARNIVELMODELO"
            ,"ELIMINARNIVELMODELO"
            ,"MODIFICARNIVELMODELO"
            //NIVELMODELO
            ,"OBTENERENCUESTA"
            ,"REGISTRARENCUESTA"
            ,"ELIMINARENCUESTA"
    ...
    private static final LinkedList<Token> tokens = new LinkedList<>(Arrays.asList(
            ...
            ,new Token(Token.FUNC, Token.MODIFICARNIVELINDICADOR, "MODIFICARNIVELINDICADOR")
            //TIPOENCUESTA
            ...
            ,new Token(Token.FUNC, Token.MODIFICARTIPOENCUESTA, "MODIFICARTIPOENCUESTA")
            //NIVELMODELO
            ...
            ,new Token(Token.FUNC, Token.MODIFICARNIVELMODELO, "MODIFICARNIVELMODELO")
            //NIVELMODELO
            ...
            ,new Token(Token.FUNC, Token.MODIFICARENCUESTA, "MODIFICARENCUESTA")
    ));
